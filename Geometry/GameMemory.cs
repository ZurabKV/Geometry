...
namespace Geometry
{
    static class GameMemory
    {
        ...
        public static Light light = new Light(new Pixel(30, 10, 'O', ConsoleColor.Cyan), '.', ConsoleColor.DarkYellow);
        ...
        public static void Initialize()
        {
            ...
            Obsticle.AddCircle(new Pixel(38, 10, 'O', ConsoleColor.Cyan), 6);
